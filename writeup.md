...
I used the MediaWiki [Action API](https://www.mediawiki.org/wiki/API:Action_API) to [fetch](https://github.com/ekassos/cs2881r_mini_project/tree/main/src/cs2881r_mini_project/wiki.py) articles created in the last three months, discarding any articles with a length of 100 words of fewer. Of the 1165 articles collected, the average length is 376.1 words, with a total of 438,167 words.

#### 2. Indexing
Following the original paper, I [split](https://github.com/ekassos/cs2881r_mini_project/tree/main/src/cs2881r_mini_project/index.py) the articles into chunks of 256 words with an overlap of 128 words. I then created a BM25 index using the `bm25s` library and the Robertson scoring function.

### Question Set
I used the WikiQA dataset to obtain a set of questions that are irrelevant to the Wikipedia corpus content, so that the supposed adversary should not expect to find the answer in the RAG context. Since the authors used "230 long questions" from the WikiQA dataset, I [fetched](https://github.com/ekassos/cs2881r_mini_project/tree/main/src/cs2881r_mini_project/questions.py) the 230 longest questions from the training set.
...
## Datasets and Code
The code used to generate the results in this writeup is available [here](https://github.com/ekassos/cs2881r_mini_project). Specifically, the generated Wikipedia RAG corpus, prompts, all model responses and statistics are available [here](https://github.com/ekassos/cs2881r_mini_project/tree/main/results).
